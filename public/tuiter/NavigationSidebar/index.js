const NavigationSidebar = (active) => {
   ...
   <div class="list-group" id="navbar">
     <a class="list-group-item" href="/" id="tuiter">
      ...
      <a href="../explore/index.html" class="list-group-item list-group-item-action ${active==='explore'?'active':''}" id="explorescreen">
      ...
      <a href="more.html" class="list-group-item list-group-item-action" id="more">
        <span class="position-relative">
          ...
          <i class="fas fa-ellipsis-h wd-more fa-xs position-absolute" style="color: white"></i>
        </span>
